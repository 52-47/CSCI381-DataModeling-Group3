...
( 
	...
	"ModelId"            "sdKey"."SurrogateKeyInteger"  NOT NULL ,
...
( 
	...
	"CategoryDescription" AS         CASE
            WHEN "TotalSalePrice" >= 100001.00 THEN 'Very High'
            WHEN "TotalSalePrice" BETWEEN 75001.00 AND 100000.00 THEN 'High'
            WHEN "TotalSalePrice" BETWEEN 50001.00 AND 75000.00 THEN 'Medium'
            WHEN "TotalSalePrice" BETWEEN 25001.00 AND 50000.00 THEN 'Low'
            WHEN "TotalSalePrice" BETWEEN 150001.00 AND 250000.00 THEN 'Exceptional'
            WHEN "TotalSalePrice" BETWEEN 100001.00 AND 150000.00 THEN 'Very High'
            WHEN "TotalSalePrice" BETWEEN 100.00 AND 25000.00 THEN 'Very Low'
            ELSE 'Unknown'
...
( 
	...
	CONSTRAINT "DF_SalesSalesOrderVehicleHistory_AuditDateTimeStamp"
		 DEFAULT  sysdatetime(),
	"DBAction"           "sdAudit"."DbAction"  NOT NULL ,
	"CategoryDescription" "sdMarketingTextString"."VehicleSalesThresholdCategory" 
)
go
...
ALTER TABLE "Audit"."HumanResourcesStaffHistory"
	ADD CONSTRAINT "XPKStaffHistory" PRIMARY KEY  NONCLUSTERED ("StaffHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Human_Resources_Staff_History" ON "Audit"."HumanResourcesStaffHistory"
( 
	"StaffId"             ASC,
...
ALTER TABLE "Audit"."LocaleCountryHistory"
	ADD CONSTRAINT "PK_CountryHistory" PRIMARY KEY  NONCLUSTERED ("LocaleCountryHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Locale_Country_History" ON "Audit"."LocaleCountryHistory"
( 
	"CountryId"           ASC,
	"TransactionNumber"   DESC
)
...
ALTER TABLE "Audit"."ProductionManufacturerModelHistory"
	ADD CONSTRAINT "XPK_ModelHistory" PRIMARY KEY  NONCLUSTERED ("ProductionManufacturerModelHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Production_Manufacturer_Model_History" ON "Audit"."ProductionManufacturerModelHistory"
( 
...
ALTER TABLE "Audit"."ProductionManufacturerVehicleMakeHistory"
	ADD CONSTRAINT "XPK_MakeHistory" PRIMARY KEY  NONCLUSTERED ("ProductionManufacturerVehicleMakeHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Production_Manufacturer_Vehicle_Make_History" ON "Audit"."ProductionManufacturerVehicleMakeHistory"
( 
...
ALTER TABLE "Audit"."ProductionManufacturerVehicleStockHistory"
	ADD CONSTRAINT "XPK_StockHistory" PRIMARY KEY  NONCLUSTERED ("ProductionManufacturerVehicleStockHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Production_Manufacturer_Vehicle_Stock_History" ON "Audit"."ProductionManufacturerVehicleStockHistory"
( 
...
ALTER TABLE "Audit"."SalesCustomerHistory"
	ADD CONSTRAINT "XPK_CustomerHistory" PRIMARY KEY  NONCLUSTERED ("SalesCustomerHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Sales_Customer_History" ON "Audit"."SalesCustomerHistory"
( 
	"CustomerId"          ASC,
	"TransactionNumber"   DESC
)
...
ALTER TABLE "Sales"."SalesOrderVehicleDetail"
	ADD CONSTRAINT "XAK1Sales_Order_Vehicle_Detail" UNIQUE ("SalesOrderVehicleId"  ASC,"ManufacturerVehicleStockId"  ASC)
go

ALTER TABLE "Audit"."SalesSalesOrderVehicleDetailHistory"
	ADD CONSTRAINT "XPK_SalesDetailsHistory" PRIMARY KEY  NONCLUSTERED ("SalesSalesOrderVehicleDetailHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Sales_Sales_Order_Vehicle_Detail_History" ON "Audit"."SalesSalesOrderVehicleDetailHistory"
( 
...
ALTER TABLE "Audit"."SalesSalesOrderVehicleHistory"
	ADD CONSTRAINT "XPKSalesOrderVehicleHistory" PRIMARY KEY  NONCLUSTERED ("SalesSalesOrderVehicleHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Sales_Sales_Order_Vehicle_History" ON "Audit"."SalesSalesOrderVehicleHistory"
( 
