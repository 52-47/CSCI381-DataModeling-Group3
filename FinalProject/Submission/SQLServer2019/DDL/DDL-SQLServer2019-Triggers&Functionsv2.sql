...
BEGIN
  DECLARE @ColumnOutputInJSONIncludingNullValues nvarchar(max) =
  (
    SELECT "d"."SalesOrderVehicleId", "d"."CustomerId", "d"."StaffId", "d"."InvoiceNumber", "d"."TotalSalePrice", "d"."SaleDate", "d"."CategoryDescription", "d"."TransactionNumber", "d"."Note", "d"."UserAuthorizationId", "d"."SysStartTime", "d"."SysEndTime", "d"."RowLevelHashKey", "d"."PriorRowLevelHashKey", "d"."FireAuditTrigger"
...
(
  "d"."SalesOrderVehicleId", "d"."CustomerId", "d"."StaffId", "d"."InvoiceNumber", "d"."TotalSalePrice", "d"."SaleDate", "d"."CategoryDescription", "d"."TransactionNumber", "d"."Note", "d"."UserAuthorizationId", "d"."SysStartTime", "d"."SysEndTime", "d"."RowLevelHashKey", "d"."PriorRowLevelHashKey", "d"."FireAuditTrigger", "d"."AuditDateTimeStamp", "d"."DBAction", "d"."isDeleted"
)
SELECT
  "d"."SalesOrderVehicleId", "d"."CustomerId", "d"."StaffId", "d"."InvoiceNumber", "d"."TotalSalePrice", "d"."SaleDate", "d"."CategoryDescription",
  "d"."TransactionNumber",
  'Last Transaction prior to deletion: ' + coalesce("d"."Note", concat('No Message Transaction Number: ', "d"."TransactionNumber")),
  "d"."UserAuthorizationId",
  "d"."SysStartTime",
...
AS
  ...
  (
   SELECT 'Current' as TransactionType, NULL AS "AuditDateTimeStamp", NULL AS "DBAction",
     "d"."SalesOrderVehicleId", "d"."CustomerId", "d"."StaffId", "d"."InvoiceNumber", "d"."TotalSalePrice", "d"."SaleDate", "d"."CategoryDescription", "d"."TransactionNumber", "d"."Note", "d"."UserAuthorizationId", "d"."SysStartTime", "d"."SysEndTime", "d"."RowLevelHashKey", "d"."PriorRowLevelHashKey", "d"."FireAuditTrigger"
   FROM "Sales"."SalesOrderVehicle" AS "d"
   WHERE "d"."SalesOrderVehicleId" = @Pky
   UNION
   SELECT 'History' as TransactionType, "d"."AuditDateTimeStamp", "d"."DBAction",
