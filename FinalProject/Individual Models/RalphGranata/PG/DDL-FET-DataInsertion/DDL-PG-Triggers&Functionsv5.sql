...
CREATE OR REPLACE FUNCTION "Sales"."funcUpdateSalesOrderVehicleCategoryDescription"()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER "uTu_SalesSalesOrderVehicleCategoryDescription"
BEFORE INSERT OR UPDATE ON "Sales"."SalesOrderVehicle"
FOR EACH ROW EXECUTE FUNCTION "Sales"."funcUpdateSalesOrderVehicleCategoryDescription"();
