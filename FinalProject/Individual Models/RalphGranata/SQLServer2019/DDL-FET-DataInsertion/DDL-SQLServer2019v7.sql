...
ALTER TABLE "Audit"."SalesSalesCategoryThresholdHistory"
	ADD CONSTRAINT "XPKSales_Sales_Category_Threshold_History" PRIMARY KEY  NONCLUSTERED ("SalesSalesCategoryThresholdHistoryId" ASC)
go

CREATE CLUSTERED INDEX "XIE1Sales_Sales_Category_Threshold_History" ON "Audit"."SalesSalesCategoryThresholdHistory"
( 
	"SalesCategoryThresholdId"  ASC,
	"TransactionNumber"   DESC
)
go
