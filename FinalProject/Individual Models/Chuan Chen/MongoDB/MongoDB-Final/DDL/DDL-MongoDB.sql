...
SELECT * FROM Mongo.uvw_SalesCategoryThreshold FOR JSON PATH, INCLUDE_NULL_VALUES;

--Staff Collection--
SELECT * FROM Mongo.uvw_Staff FOR JSON PATH, INCLUDE_NULL_VALUES;

--Country Collection--
SELECT * FROM Mongo.uvw_Country FOR JSON PATH, INCLUDE_NULL_VALUES;

--UserAuthorization Collection--
SELECT * FROM Mongo.uvw_UserAuthorization FOR JSON PATH, INCLUDE_NULL_VALUES;

--Customer Collection--
SELECT * FROM Mongo.uvw_Customer FOR JSON PATH, INCLUDE_NULL_VALUES;
...
SELECT * FROM Mongo.uvw_SalesOrderVehicle FOR JSON PATH, INCLUDE_NULL_VALUES;
...
FROM Production.ManufacturerVehicleMake as PMVM FOR JSON PATH, INCLUDE_NULL_VALUES;;

-- ManufacturerVehicleModel Collection --

SELECT * FROM Mongo.uvw_ManufacturerModel FOR JSON PATH, INCLUDE_NULL_VALUES;

-- ManufacturerVehicleModel Collection --
SELECT * FROM Mongo.uvw_ManufacturerVehicleStock FOR JSON PATH , INCLUDE_NULL_VALUES;

-- SalesOrderVehicleDetail Collection --
SELECT * FROM Mongo.uvw_SalesOrderVehicleDetail FOR JSON PATH , INCLUDE_NULL_VALUES;