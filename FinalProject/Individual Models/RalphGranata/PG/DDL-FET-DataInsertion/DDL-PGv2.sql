...
CREATE INDEX "XIE1Human_Resources_Staff_History" ON "Audit"."HumanResourcesStaffHistory"
( 
	"StaffId" ASC,
...
CREATE INDEX "XIE1Locale_Country_History" ON "Audit"."LocaleCountryHistory"
( 
	"CountryId" ASC,
	"TransactionNumber" DESC
);
...
( 
	...
	"RepairsCharge"      numeric(18,2)  NOT NULL   DEFAULT  0,
	"PartsCharge"        numeric(18,2)  NOT NULL   DEFAULT  0,
	"DeliveryCharge"     numeric(18,2)  NOT NULL   DEFAULT  0,
...
CREATE INDEX "XIE1Production_Manufacturer_Model_History" ON "Audit"."ProductionManufacturerModelHistory"
( 
...
CREATE INDEX "XIE1Production_Manufacturer_Vehicle_Make_History" ON "Audit"."ProductionManufacturerVehicleMakeHistory"
( 
...
CREATE INDEX "XIE1Production_Manufacturer_Vehicle_Stock_History" ON "Audit"."ProductionManufacturerVehicleStockHistory"
( 
...
CREATE INDEX "XIE1Sales_Customer_History" ON "Audit"."SalesCustomerHistory"
( 
	"CustomerId" ASC,
	"TransactionNumber" DESC
);
...
CREATE INDEX "XIE1Sales_Sales_Category_Threshold_History" ON "Audit"."SalesSalesCategoryThresholdHistory"
( 
...
CREATE INDEX "XIE1Sales_Sales_Order_Vehicle_Detail_History" ON "Audit"."SalesSalesOrderVehicleDetailHistory"
( 
...
CREATE INDEX "XIE1Sales_Sales_Order_Vehicle_History" ON "Audit"."SalesSalesOrderVehicleHistory"
( 
